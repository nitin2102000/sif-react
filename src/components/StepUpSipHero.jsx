...
import { faCalculator, faStairs, faMoneyBillTrendUp, faChartLine } from '@fortawesome/free-solid-svg-icons'
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <motion.p
                ...
                Supercharge your wealth creation by increasing your SIP amount every year in line with your rising income. 
              </motion.p>
            </div>
            ...
            <motion.div
              ...
              {[
                { icon: faStairs, label: 'Annual Increase', val: 'Step Up', color: 'from-blue-300 to-cyan-400' },
                { icon: faMoneyBillTrendUp, label: 'Exponential', val: 'Compounding', color: 'from-green-400 to-emerald-500' },
                { icon: faChartLine, label: 'Beat Inflation', val: 'Grow Faster', color: 'from-amber-400 to-orange-500' },
