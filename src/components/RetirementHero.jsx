...
import { faUmbrellaBeach, faPiggyBank, faArrowTrendUp, faCalculator } from '@fortawesome/free-solid-svg-icons'
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <motion.p
                ...
                Find out exactly how much you need to save today to live the retirement life you've always dreamed of.
              </motion.p>
            </div>
            ...
            <motion.div
              ...
              {[
                { icon: faUmbrellaBeach, label: 'Dream Life', val: 'Plan Ahead', color: 'from-blue-300 to-cyan-400' },
                { icon: faPiggyBank, label: 'Monthly Goal', val: 'Start Saving', color: 'from-green-400 to-emerald-500' },
                { icon: faArrowTrendUp, label: 'Beat Inflation', val: 'Stay Ahead', color: 'from-amber-400 to-orange-500' },
                { icon: faCalculator, label: 'Instant Results', val: 'Real-time', color: 'from-purple-400 to-violet-500' },
              ].map((stat, i) => (
