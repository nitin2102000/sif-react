        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <motion.h2
              ...
              className="text-3xl lg:text-4xl font-bold text-white mb-6 font-serif leading-tight"
            >
            ...
            >
              Our experts are ready to help you compare funds, understand risks, and choose the right investment opportunities.
            </motion.p>
