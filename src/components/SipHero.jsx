...
import { faCalculator, faChartLine, faArrowTrendUp, faCoins } from '@fortawesome/free-solid-svg-icons'
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <motion.p
                ...
                Estimate the future value of your monthly investments with our intelligent SIP calculator. Adjust investment amount, expected annual return, and investment duration to plan your wealth creation journey.
              </motion.p>
            </div>
            ...
            <motion.div
              ...
              {[
                ...
                { icon: faChartLine, label: 'Chart Projection', val: 'Year-wise', color: 'from-green-400 to-emerald-500' },
                { icon: faArrowTrendUp, label: 'Avg. SIP Return', val: '12–18%', color: 'from-amber-400 to-orange-500' },
                { icon: faCoins, label: 'Min. SIP Amount', val: '₹500/mo', color: 'from-purple-400 to-violet-500' },
              ].map((stat, i) => (
