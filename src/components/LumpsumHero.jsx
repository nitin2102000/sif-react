...
import { faCalculator, faMoneyBillWave, faArrowTrendUp, faPiggyBank } from '@fortawesome/free-solid-svg-icons'
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <motion.p
                ...
                Calculate the future value of your one-time investment. See how the power of compounding can grow your wealth exponentially over time.
              </motion.p>
            </div>
            ...
            <motion.div
              ...
              {[
                ...
                { icon: faArrowTrendUp, label: 'Growth Tracking', val: 'Compounding', color: 'from-green-400 to-emerald-500' },
                { icon: faMoneyBillWave, label: 'Tax Efficient', val: 'LTCG', color: 'from-amber-400 to-orange-500' },
                { icon: faPiggyBank, label: 'One Time', val: 'Investment', color: 'from-purple-400 to-violet-500' },
              ].map((stat, i) => (
